  ...
  options.my.zfs =
    ...
    let
      ...
      nonEmptyListOfUniqueDriveIDs =
        let
          type = addCheck (nonEmptyListOf driveID)
      ...
      partitionOption = isRequired:
        ...
        then { type = uniq partitionNum; description = "unique partition number"; }
        else { type = uniq (nullOr partitionNum); default = null; description = "unique partition number"; });
