...
in
{
  ...
  hardware.enableAllFirmware = true;      # enable all firmware updates regardless of license
  hardware.enableRedistributableFirmware = true; # with license allowing redistribution
